...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
		...
		System.out.println("NumChars\tBasic Time\tEfficient Time");
				...
				numToCheck += increment)
		{
			...
			System.out.print((end1-start1)/100000000 + "\t \t");
			long start2 = System.nanoTime();
			for(int i = 0; i<100; i++) {
				EfficientDocument doc1 = new EfficientDocument(text);
				doc1.getFleschScore();
			}
			long end2 = System.nanoTime();
			System.out.print((end2-start2)/100000000 + "\n");
